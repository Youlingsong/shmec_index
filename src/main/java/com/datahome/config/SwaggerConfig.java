...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        ticketPar.name("cookie").description("cookie")
    ...
    private ApiInfo apiInfo() { return new ApiInfoBuilder().title("学前新需求接口说明文档").description("指标管理").termsOfServiceUrl("http://www.mackson.xyz").version("1.0").build(); }
}
